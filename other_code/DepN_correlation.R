...
p <- ggplot()+
  ...
  annotate("text", label = "r = 0.59", x = 50, y = 25, color = "black")+
...
p2 <- ggplot()+
  ...
  annotate("text", label = "r = 0.84", x = 35, y = 60, color = "black")+
...
p3 <- ggplot()+
  ...
  annotate("text", label = "r = 0.75", x = -18, y = 20, color = "black")+
...
ggsave(p_final, filename = "./visualizations/final_figures/Dep_Ncorr.png", dev = "png",
